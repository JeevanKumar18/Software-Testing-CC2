...
public class AppTest 
{
    ...
    public void setup() {
        ...
        ExtentSparkReporter spark = new ExtentSparkReporter(
                "D:\\cc2(ST)\\cc2\\src\\report\\result.html");
        reports.attachReporter(spark);
        test = reports.createTest("Demo Result");
        WebDriverManager.chromedriver().setup();
        driver = new ChromeDriver();
        PropertyConfigurator.configure("D:\\cc2(ST)\\cc2\\src\\test\\java\\com\\resource\\log4j.properties");
    }
    @BeforeMethod
    ...
    public void testCase1() throws IOException, InterruptedException {
        ...
        FileInputStream fs = new FileInputStream("D:\\cc2(ST)\\cc2\\src\\test\\java\\com\\resource\\cc2.xlsx");
    ...
    public void testCase3() throws InterruptedException, IOException {
        ...
        String path = "D:\\cc2(ST)\\cc2\\src\\test\\java\\com\\resource\\screenShot.png";
